  ...
  return (
    <div className="absolute inset-0 flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto min-w-0">
        ...
        {/* Report header */}
        <div className="flex items-center justify-between px-7 border-b border-border shrink-0 h-[72px]" style={{ background: "rgba(153,204,51,0.07)" }}>
        ...
        <div className="flex flex-col shrink-0 mt-6">
          ...
          <div className="px-7 border-b border-border flex items-center gap-2 h-[72px] shrink-0" style={{ background: "rgba(153,204,51,0.07)" }}>
            <span className="text-accent font-bold text-sm leading-none">/</span>
